...
//        comboBox.addItem("LCMMax");
        ...
        comboBox.addItem("  ---- HIGH UTILITY PATTERN MINING ----");
        comboBox.addItem("d2HUP");
        comboBox.addItem("EFIM");
        comboBox.addItem("FHM");
        comboBox.addItem("FHN");
        comboBox.addItem("FOSHU");
        comboBox.addItem("HUI-Miner");
        comboBox.addItem("HUG-Miner");
        comboBox.addItem("HUP-Miner");
        comboBox.addItem("HUINIV-Mine");
        comboBox.addItem("HUSRM");
        comboBox.addItem("IHUP");
        comboBox.addItem("TS-HOUN");
	...
	private void updateUserInterfaceAfterAlgorithmSelection(String algorithmName, boolean isSelected) {
        ...
        if (isSelected) {
            ...
            if ("PrefixSpan".equals(algorithmName)
                ...
                setParam(textFieldParam4, "Show sequence ids? (optional):", labelParam4, "(default: false)");
            }else if ("SPAM".equals(algorithmName)) {
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose minsup (%):", labelParam1, "(e.g. 0.5 or 50%)");
                setParam(textFieldParam2, "Min pattern length (optional):", labelParam2, "(e.g. 1 items)");
                setParam(textFieldParam3, "Max pattern length (optional):", labelParam3, "(e.g. 4 items)");
                setParam(textFieldParam4, "Max gap (optional):", labelParam4, "(e.g. 1 item)");
                setParam(textFieldParam5, "Show sequence ids? (optional):", labelParam5, "(default: false)");
            ...
            //					comboBox.addItem("Fournier08-Closed+time+valued_items");
                ...
                setParam(textFieldParam3, "Choose distance function:", labelParam3, "(e.g. euclidian, cosine...)");
                ...
                setParam(textFieldParam4, "Choose distance function:", labelParam4, "(e.g. euclidian, cosine...)");
                ...
                setParam(textFieldParam3, "Choose delta:", labelParam3, "(e.g. 2)");
            		...
            		|| "UPGrowth+".equals(algorithmName)
            		|| "d2HUP".equals(algorithmName)
            		|| "EFIM".equals(algorithmName)
            		|| "HUG-Miner".equals(algorithmName)
                ...
                hideAllParams();
                setParam(textFieldParam1, "Choose minutility:", labelParam1, "(e.g. 30)");
                setParam(textFieldParam2, "Choose number of partitions:", labelParam2, "(e.g. 2)");
            }else if ("HUSRM".equals(algorithmName)) {
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose minutility:", labelParam1, "(e.g. 40)");
                setParam(textFieldParam2, "Choose minconfidence:", labelParam2, "(e.g. 0.7)");
                setParam(textFieldParam3, "Choose max antecendent size:", labelParam3, "(e.g.4)");
                setParam(textFieldParam4, "Choose max consequent size:", labelParam4, "(e.g.4)");
            }else if ("FOSHU".equals(algorithmName)) {
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose minutility ratio:", labelParam1, "(e.g. 0.8)");
            }else if ("TS-HOUN".equals(algorithmName)) {
                // show the parameters of this algorithm
                hideAllParams();
                setParam(textFieldParam1, "Choose minutility ratio:", labelParam1, "(e.g. 0.8)");
                setParam(textFieldParam2, "Period count?", labelParam2, "(e.g. 3)");
...
//		.setVisible(false);
    ...
    private void openHelpWebPageForAlgorithm(String choice) {
        ...
        } else if ("HUP-Miner".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#hupminer");
        }else if ("EFIM".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#efim");
        }else if ("HUG-Miner".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#hugminer");
        }else if ("CPT".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#cpt");
        }else if ("CPT+".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#cptPlus");
        }else if ("PPM".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#ppm");
        }else if ("DG".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#dg");
        }else if ("AKOM".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#akom");
        }else if ("TDAG".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#tdag");
        }else if ("LZ78".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#lz78");
        }else if ("FOSHU".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#foshu");
        }else if ("TS-HOUN".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#tshoun");
        }else if ("HUSRM".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#husrm");
        }else if ("EIHI".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#eihi");
        }else if ("HUI-LIST-INS".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#huilistins");
        }else if ("FHM".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#fhm");
        } else if ("d2HUP".equals(choice)) {
            openWebPage("http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#d2hup");
